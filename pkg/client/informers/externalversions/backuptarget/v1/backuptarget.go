...
import (
	...
	versioned "github.com/datakube/datakube/pkg/client/clientset/versioned"
	internalinterfaces "github.com/datakube/datakube/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/datakube/datakube/pkg/client/listers/backuptarget/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.DatakubeV1().BackupTargets(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatakubeV1().BackupTargets(namespace).Watch(options)
			},
		},
		&backuptargetv1.BackupTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backupTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backuptargetv1.BackupTarget{}, f.defaultInformer)
}

func (f *backupTargetInformer) Lister() v1.BackupTargetLister {
	return v1.NewBackupTargetLister(f.Informer().GetIndexer())
}
