...
func init() {
	proto.RegisterType((*RegisterRequest)(nil), "connect.RegisterRequest")
	proto.RegisterType((*Target)(nil), "connect.Target")
	proto.RegisterType((*RegisterResponse)(nil), "connect.RegisterResponse")
}
...
func (c *dumperServiceClient) RegisterDumper(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := grpc.Invoke(ctx, "/connect.DumperService/RegisterDumper", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DumperService_RegisterDumper_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connect.DumperService/RegisterDumper",
	}
...
var _DumperService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "connect.DumperService",
...
var fileDescriptor0 = []byte{
	...
	,
}
